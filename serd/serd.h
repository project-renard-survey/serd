...
/// Sink wrapper that normalises nodes
typedef struct SerdNormaliserImpl SerdNormaliser;
...
/// Return a sink interface that forwards statements with normalised nodes
SERD_API
const SerdSink*
